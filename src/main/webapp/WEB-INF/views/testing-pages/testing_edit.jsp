...
<form:form modelAttribute="${attr}" id="frm" method="post">
   <div id="stylized" class="myformPopup forms" style="margin: 10px;">
		...
		<fmt:formatDate value="${testing.startDate}" type="date" var="startDate"
		pattern="MM/dd/yyyy" />
		...
		<fmt:formatDate value="${testing.endDate}" type="date" var="endDate"
		pattern="MM/dd/yyyy" />
		...
		<form:hidden path="id" />
		<fmt:formatDate value='${testing.createdDate}' type='both' var="dt" />
