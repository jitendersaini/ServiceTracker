...
<form:form modelAttribute="${attr}" id="frm" method="post">
   <div id="stylized" class="myformPopup forms" style="margin: 10px;">
		...
		<fmt:formatDate value="${rh.startDate}" type="date" var="startDate"
		pattern="MM/dd/yyyy" />
		...
		<fmt:formatDate value="${rh.endDate}" type="date" var="endDate"
		pattern="MM/dd/yyyy" />
		...
		<form:hidden path="id" />
		<fmt:formatDate value='${rh.createdDate}' type='both' var="dt" />
