...
<form:form modelAttribute="${attr}" id="frm" method="post">
   <div id="stylized" class="myformPopup forms" style="margin: 10px;">
		...
		<fmt:formatDate value="${support.startDate}" type="date" var="startDate"
		pattern="MM/dd/yyyy" />
		...
		<fmt:formatDate value="${support.endDate}" type="date" var="endDate"
		pattern="MM/dd/yyyy" />
		...
		<form:hidden path="id" />
		<fmt:formatDate value='${support.createdDate}' type='both' var="dt" />
