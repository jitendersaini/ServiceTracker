$(function() {
	...
	$("#create_pt").button().click(function() {
		...
		loadpopupform("users/processtools/action?create=");
	});
	
	$("#edit_pt").button().click(function() {
		edit("users/processtools/action?edit=&id=");		
	});
	
	$("#delete_pt").button().click(function() {
		remove('users/processtools/action?remove=&id=');
	});
...
function populateDialog() {
	...
	$("#dialog-form").dialog({
		...
		buttons : {
			"Save" : function() {
				if (validateForm()) {
					save('users/processtools/action?save=', 'frm');
					$(this).dialog("close");
				}
			},
			Cancel : function() {
...
function search() {
	ajaxCallsWithPaging('users/processtools/action?search=', 'post',
