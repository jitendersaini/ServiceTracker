					...
					buttons : {
						"Save" : function() {
							if (local.functions.validateForm()) {
								global.functions.save('users/rehearsal/action?save=', 'frm');
								$(this).dialog("close");
							}
						},
						Cancel : function() {
...
$(function() {
	$("#button_actions_rh button:first").button({
		icons : {
	...
	$("#create_rh").button().click(function() {
		
		//alert($('#tabs ul').find('.ui-tabs-active').index());		
		global.functions.loadpopupform("users/rehearsal/action?create=");
	});
	
	$("#edit_rh").button().click(function() {
		local.functions.edit("users/rehearsal/action?edit=&id=");		
	});
	
	$("#delete_rh").button().click(function() {
		global.functions.remove('users/rehearsal/action?remove=&id=');
	});
