$(function() {
	...
	$("#create_walkthrough").button().click(function() {
		...
		loadpopupform("users/walkthrough/action?create=");
	});
	
	$("#edit_walkthrough").button().click(function() {
		edit("users/walkthrough/action?edit=&id=");		
	});
	
	$("#delete_walkthrough").button().click(function() {
		remove('users/walkthrough/action?remove=&id=');
	});
...
function populateDialog() {
	...
	$("#dialog-form").dialog({
		...
		buttons : {
			"Save" : function() {
				if (validateForm()) {
					save('users/walkthrough/action?save=', 'frm');
					$(this).dialog("close");
				}
			},
			Cancel : function() {
...
function search() {
	ajaxCallsWithPaging('users/walkthrough/action?search=', 'post',
