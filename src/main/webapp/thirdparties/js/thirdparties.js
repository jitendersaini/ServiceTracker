$(function() {
	...
	$("#create_tp").button().click(function() {
		...
		loadpopupform("users/thirdparties/action?create=");
	});
	
	$("#edit_tp").button().click(function() {
		edit("users/thirdparties/action?edit=&id=");		
	});
	
	$("#delete_tp").button().click(function() {
		remove('users/thirdparties/action?remove=&id=');
	});
...
function populateDialog() {
	...
	$("#dialog-form").dialog({
		...
		buttons : {
			"Save" : function() {
				if (validateForm()) {
					save('users/thirdparties/action?save=', 'frm');
					$(this).dialog("close");
				}
			},
			Cancel : function() {
...
function search() {
	ajaxCallsWithPaging('users/thirdparties/action?search=', 'post',
