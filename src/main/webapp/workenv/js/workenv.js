					...
					buttons : {
						"Save" : function() {
							if (local.functions.validateForm()) {
								global.functions.save('users/workenv/action?save=', 'frm');
								$(this).dialog("close");
							}
						},
						Cancel : function() {
...
$(function() {
	...
	$("#create").button().click(function() {
		...
		global.functions.loadpopupform("users/workenv/action?create=");
	});
	
	$("#edit").button().click(function() {
		local.functions.edit("users/workenv/action?edit=&id=");		
	});
	
	$("#delete").button().click(function() {
		global.functions.remove('users/workenv/action?remove=&id=');
	});
