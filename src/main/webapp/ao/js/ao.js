					...
					buttons : {
						"Save" : function() {
							if (local.functions.validateForm()) {
								global.functions.save('users/accessao/action?save=', 'frm');
								$(this).dialog("close");
							}
						},
						Cancel : function() {
...
$(function() {
	$("#button_actions_ao button:first").button({
		icons : {
	...
	$("#create_ao").button().click(function() {
		
		//alert($('#tabs ul').find('.ui-tabs-active').index());		
		global.functions.loadpopupform("users/accessao/action?create=");
	});
	
	$("#edit_ao").button().click(function() {
		local.functions.edit("users/accessao/action?edit=&id=");		
	});
	
	$("#delete_ao").button().click(function() {
		global.functions.remove('users/accessao/action?remove=&id=');
	});
