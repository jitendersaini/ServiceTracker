$(function() {
	...
	$("#create_ao").button().click(function() {
		...
		loadpopupform("users/accessao/action?create=");
	});
	
	$("#edit_ao").button().click(function() {
		edit("users/accessao/action?edit=&id=");		
	});
	
	$("#delete_ao").button().click(function() {
		remove('users/accessao/action?remove=&id=');
	});
...
function populateDialog() {
	...
	$("#dialog-form").dialog({
		...
		buttons : {
			"Save" : function() {
				if (validateForm()) {
					save('users/accessao/action?save=', 'frm');
					$(this).dialog("close");
				}
			},
			Cancel : function() {
...
function search() {
	ajaxCallsWithPaging('users/accessao/action?search=', 'post',
