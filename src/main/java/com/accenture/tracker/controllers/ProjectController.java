...
public class ProjectController {
	...
	@RequestMapping(value = "/projects/action", params = { "create" })
	...
	@RequestMapping(value = "/projects/action", params = { "remove" })
	public @ResponseBody String removeData(ModelMap model, String id) {
		projectsService.remove(id);
		return "";
	}

	@RequestMapping(value = "/projects/action", params = { "edit" })
	...
	@RequestMapping(value = "/projects/action", params = { "save" })
	...
	@RequestMapping(value = "/projects/action", params = { "search" })
