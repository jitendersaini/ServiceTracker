...
public class AppConstants {
	...
	/** Password Wallet */
	public static final String PASSWORD_WALLET_LIST = "wallet-page/wallet_list";
	public static final String PASSWORD_WALLET_DATA_TABLE = "wallet-page/wallet_data";
	public static final String PASSWORD_WALLET_CREATE = "wallet-page/wallet_create";
	public static final String PASSWORD_WALLET_CREATE_QA = "wallet-page/wallet_create_qa";
	public static final String PASSWORD_WALLET_ENTRY_MODIFY = "wallet-page/wallet_modify";
	public static final String PASSWORD_WALLET_QA_MODIFY = "wallet-page/wallet_modify_qa";
